...
INSERT INTO public.properties VALUES (9, 18.998, -220, -118.1, 1);
...
--
-- Name: elements name_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT name_symbol UNIQUE (name);
